...
<body >
   ...
   <div id="mySidenav" class="sidenav">
    ...
    <div class="content">
   		<%
			List<TaskModel> user =TaskDAO.getAllTask();
		%>
   		<table>
   		 <%if(user.size()!=0){%>
        <tr>
          <th style="border-top-left-radius:30px;">TASK NAME</th>
          <th>DATE</th>
          <th>TYPE</th>
          <th>ASSIGNED TO</th>
          <th>HOURS</th>
          <th>FROM TIME</th>
          <th>TO TIME</th>
          <th  style="border-top-right-radius:30px;">LINK</th>
        </tr>
       
        <% for(TaskModel i : user){%>
        <tr>
          <td><%= i.getTaskname()%></td>
          <td><%= i.getDate()%></td>
          <td><%= i.getType()%></td>
          ...
          <td><%= i.getFromTime()%></td>
          <td><%= i.getToTime()%></td>
          <td><a href="<%= i.getLink()%>" target="blank" style="color:white;text-decoration:none">click</a></td>
        </tr>
        <%}}else{ %>
        	<h1 style="margin-left:300px;color:white">STAY HAPPY...NO TASK ASSIGNED</h1>
      	<%} %>
      </table>

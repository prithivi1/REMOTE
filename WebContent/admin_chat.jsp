...
<body>
	<div class="header">
        ...
        <div class="topbar">
            <div class="icons">
                ...
                <div class="links">
                <a href="logout.jsp" class="one" style="text-decoration:none;"><i style="color: #800080" class="fa fa-sign-out" aria-hidden="true"><br></i><br><span class="tooltiptext"><b>logout</b></span></a></div>

                <div class="links">
                <a href="admin_profile.jsp" class="one" style="text-decoration:none;padding-left: 10px;padding-right: 15px"><i style="color: #2196F3" class="fa fa-user-circle" aria-hidden="true"></i><br><span class="tooltiptext"><b>profile</b></span></a></div>

                	<div class="links">                
                <a href="Break?action=breaklunch"  class="one" style="text-decoration:none;"><i style="color: #f44336" class="fa fa-cutlery" aria-hidden="true"></i><br><span class="tooltiptext"><b>lunch</b></span></a></div>
                ...
                <div class="links">
                <a href="Break?action=breaktea" class="one" style="text-decoration:none;"><i style="color: #ff8000" class="fa fa-coffee" aria-hidden="true"></i><br><span class="tooltiptext"><b>break</b></span></a></div>
               ...
               <div class="links"><a href="https://meet.google.com/lookup/fpn42pl5n7?authuser=0&hs=179" target="blank"class="one" style="text-decoration:none;"><i style="color: #4CAF50" class="fa fa-users" aria-hidden="true"></i><br><span class="tooltiptext" style="margin-left: 5px;"><b>meet</b></span></a></div>
            </div>    
        </div>
    </div>
	...
	<script type="text/javascript">
		window.onload = initPage;
			  ...
			  function load(){
				  console.log(5);
				   setInterval(function () {$("#box").load(window.location.href + " #box" );}, 5000);  
			  }
